...
function Eo(n, e = () => {
  ...
  return __async(this, null, function* () {
    function o(i, s, r) {
      return __async(this, null, function* () {
        try {
          yield i.function(i.data), yield s(kt(i.data) ? {} : i.data);
        } catch {
          r(kt(i.data) ? {} : i.data);
        }
      });
    }
    return n.reduce((i, s) => __async(this, null, function* () {
      return yield i, o(s, e, t);
    }), Promise.resolve());
  });
}
function At(n) {
...
function qe(n, ...e) {
  ...
  const t = e.shift();
  if (R(n) && R(t)) for (const o in t) R(t[o]) ? (n[o] || Object.assign(n, {
    [o]: {}
  }), qe(n[o], t[o])) : Object.assign(n, {
    [o]: t[o]
  });
  return qe(n, ...e);
}
...
var d = class _d {
  ...
  static getDeepestNode(e, t = false) {
    ...
    if (e && e.nodeType === Node.ELEMENT_NODE && e[o]) {
      let s = e[o];
      if (_d.isSingleTag(s) && !_d.isNativeInput(s) && !_d.isLineBreakTag(s)) if (s[i]) s = s[i];
  ...
  static canSetCaret(e) {
    let t = true;
    if (_d.isNativeInput(e)) switch (e.type) {
      case "file":
      case "checkbox":
      case "radio":
      case "hidden":
...
var y = class _y {
  ...
  constructor({
    ...
    }, this.mutableListenerIds = [], new.target === _y) throw new TypeError("Constructors for abstract class Module are not allowed.");
...
var b = class _b {
  ...
  static get rect() {
    ...
    if (!window.getSelection) return I("Method window.getSelection is not supported", "warn"), o;
    if (e = window.getSelection(), e.rangeCount === null || isNaN(e.rangeCount)) return I("Method SelectionUtils.rangeCount is not supported", "warn"), o;
...
function zt(n, e) {
  return __async(this, null, function* () {
    const o = (yield n.save()).data, i = e.find((s) => s.name === n.name);
    return i !== void 0 && !Qe(i, "export") ? [] : e.reduce((s, r) => {
      if (!Qe(r, "import") || r.toolbox === void 0) return s;
      const l = r.toolbox.filter((a) => {
        if (V(a) || a.icon === void 0) return false;
        if (a.data !== void 0) {
          if (Ht(a.data, o)) return false;
        } else if (r.name === n.name) return false;
        return true;
      });
      return s.push(__spreadProps(__spreadValues({}, r), {
        toolbox: l
      })), s;
    }, []);
  });
...
var D = class _D extends Te {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      a || c ? u = true : u = !(l.length > 0 && l.every((p) => {
        ...
        return [...Array.from(g), ...Array.from(f), k].some((S) => (d.isElement(S) || (S = S.parentElement), S && S.closest('[data-mutation-free="true"]') !== null));
  ...
  set selected(e) {
    ...
    (t || o) && ((i = this.editorEventBus) == null || i.emit(Rt, {
      state: e
    }), t ? b.addFakeCursor() : b.removeFakeCursor(this.holder), (s = this.editorEventBus) == null || s.emit(Ft, {
      state: e
    }));
  }
  /**
  ...
  call(e, t) {
    if (O(this.toolInstance[e])) {
      e === "appendCallback" && I("`appendCallback` hook is deprecated and will be removed in the next major release. Use `rendered` hook instead", "warn");
      try {
...
var zo = class extends y {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, l) => {
    ...
    }), this.update = (e, t, o) => __async(this, null, function* () {
      const {
        BlockManager: i
      } = this.Editor, s = i.getBlockById(e);
      if (s === void 0) throw new Error(`Block with id "${e}" not found`);
      const r = yield i.update(s, t, o);
      return new G(r);
    }), this.convert = (e, t, o) => __async(this, null, function* () {
      var h, p;
      const {
        BlockManager: i,
        Tools: s
      } = this.Editor, r = i.getBlockById(e);
      ...
      if (c && u) {
        const g = yield i.convert(r, t, o);
        return new G(g);
      } else {
        const g = [c ? false : Le(r.name), u ? false : Le(t)].filter(Boolean).join(" and ");
   ...
   */
  swap(e, t) {
    I("`blocks.swap()` method is deprecated and will be removed in the next major release. Use `block.move()` method instead", "info"), this.Editor.BlockManager.swap(e, t);
  }
  /**
  ...
  stretchBlock(e, t = true) {
    Ze(true, "blocks.stretchBlock()", "BlockAPI");
    ...
    return function(t) {
      ...
      return i.m = t, i.c = o, i.d = function(s, r, l) {
        ...
        if (i.r(l), Object.defineProperty(l, "default", {
          enumerable: true,
          value: s
        }), 2 & r && typeof s != "string") for (var a in s) i.d(l, a, (function(c) {
          return s[c];
        }).bind(null, a));
        return l;
      }, i.n = function(s) {
...
`);
      ...
      function f(v, m) {
        for (var x = 0; x < v.length; x++) {
          ...
          if (M) {
            ...
            var P = [];
            for (T = 0; T < E.parts.length; T++) P.push(j(E.parts[T], m));
            l[E.id] = {
              id: E.id,
              refs: 1,
              parts: P
      ...
      function k(v, m) {
        for (var x = [], E = {}, M = 0; M < v.length; M++) {
          var T = v[M], P = m.base ? T[0] + m.base : T[0], B = {
            css: T[1],
            media: T[2],
            sourceMap: T[3]
          };
          E[P] ? E[P].parts.push(B) : x.push(E[P] = {
            id: P,
            parts: [B]
          });
        }
...
`);
      ...
      function S(v) {
        if (v.parentNode === null) return false;
      ...
      function j(v, m) {
        ...
        } else v.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (x = function(B) {
...
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(He)))) + " */");
          ...
          if (ie && B.setAttribute("media", ie), B.styleSheet) B.styleSheet.cssText = ge;
          else {
      ...
      t.exports = function(v, m) {
        ...
        return f(x, m), function(E) {
          ...
          for (E && f(k(E, m), m), T = 0; T < M.length; T++) {
            var B;
            if ((B = M[T]).refs === 0) {
              for (var Y = 0; Y < B.parts.length; Y++) B.parts[Y]();
              delete l[B.id];
            }
          }
        };
...
`);
      ...
      function fe(v, m, x, E) {
        var M = x ? "" : E.css;
        if (v.styleSheet) v.styleSheet.cssText = oe(m, M);
        else {
    ...
    return function(t) {
      ...
      class s {
        ...
        loadStyles() {
          ...
          const a = i(2), c = this.make("style", null, {
...
var le = class _le {
  ...
  constructor(e) {
    this.iterator = null, this.activated = false, this.flipCallbacks = [], this.onKeyDown = (t) => {
      if (this.isEventReadyForHandling(t)) switch (_le.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode) {
        case w.TAB:
...
var Li = class {
  ...
  constructor(e) {
    this.nodes = {
      ...
      title: d.make("div", ke.title, {
        textContent: e.title
      })
    }, this.nodes.root.appendChild(this.nodes.title), e.description !== void 0 && (this.nodes.description = d.make("div", ke.description, {
...
var se = class extends rt {
  ...
  make(e, t) {
    ...
    return e.name && (i.dataset.itemName = e.name), this.nodes.icon = d.make("div", [L.icon, L.iconTool], {
      ...
      innerHTML: wi
    })), this.isActive && i.classList.add(L.active), e.isDisabled && i.classList.add(L.disabled), e.hint !== void 0 && ((s = t == null ? void 0 : t.hint) == null ? void 0 : s.enabled) !== false && this.addHint(i, __spreadProps(__spreadValues({}, e.hint), {
...
var Ee = class extends rt {
  ...
  constructor(e, t) {
    ...
    }, this.nodes.root.appendChild(e.element), e.name && (this.nodes.root.dataset.itemName = e.name), e.hint !== void 0 && ((o = t == null ? void 0 : t.hint) == null ? void 0 : o.enabled) !== false && this.addHint(this.nodes.root, __spreadProps(__spreadValues({}, e.hint), {
...
var Vt = class extends Te {
  ...
  constructor(e, t = {}) {
    super(), this.params = e, this.itemsRenderParams = t, this.listeners = new Ce(), this.messages = {
      ...
      search: "Search"
    }, this.items = this.buildItems(e.items), e.messages && (this.messages = __spreadValues(__spreadValues({}, this.messages), e.messages)), this.nodes = {}, this.nodes.popoverContainer = d.make("div", [N.popoverContainer]), this.nodes.nothingFoundMessage = d.make("div", [N.nothingFoundMessage], {
    ...
    }), this.nodes.popoverContainer.appendChild(this.nodes.items), this.listeners.on(this.nodes.popoverContainer, "click", (o) => this.handleClick(o)), this.nodes.popover = d.make("div", [N.popover, this.params.class]), this.nodes.popover.appendChild(this.nodes.popoverContainer);
  }
  /**
...
var Di = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Pi(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
...
var qt = class Zt extends Vt {
  ...
  constructor(e, t) {
    super(e, t), this.nestingLevel = 0, this.nestedPopoverTriggerItem = null, this.previouslyHoveredItem = null, this.scopeElement = document.body, this.hide = () => {
      ...
      allowedKeys: [w.TAB, w.UP, w.DOWN, w.ENTER]
  ...
  get flippableElements() {
    return this.items.map((t) => {
      if (t instanceof se) return t.getElement();
...
var Ri = class extends lt {
  ...
  constructor(e) {
    const t = !pe();
    super(__spreadProps(__spreadValues({}, e), {
   ...
   */
  show() {
    this.nestingLevel === 0 && this.nodes.popover.style.setProperty(de.InlinePopoverWidth, this.size.width + "px"), super.show();
  }
  /**
  ...
  setTriggerItemPosition(e, t) {
    ...
    e.style.setProperty(de.TriggerItemLeft, s + "px");
  }
  /**
   * Handles displaying nested items for the item.
...
var Gt = class we {
   ...
   */
  lockHard() {
    this.scrollPosition = window.pageYOffset, document.documentElement.style.setProperty("--window-scroll-offset", `${this.scrollPosition}px`), document.body.classList.add(we.CSS.scrollLockedHard);
  }
  /**
...
var Ui = class extends y {
   ...
   */
  open() {
    return __async(this, arguments, function* (e = this.Editor.BlockManager.currentBlock) {
      var s;
      ...
      this.popover = new i({
        searchable: true,
        items: yield this.getTunesItems(e, o, t),
  ...
  getTunesItems(e, t, o) {
    return __async(this, null, function* () {
      ...
      const s = Array.from(this.Editor.Tools.blockTools.values()), l = (yield zt(e, s)).reduce((a, c) => (c.toolbox.forEach((u) => {
        a.push({
          icon: u.icon,
          title: z.t(K.toolNames, u.title),
          name: c.name,
          closeOnActivate: true,
          onActivate: () => __async(this, null, function* () {
            const {
              BlockManager: h,
              Caret: p,
              Toolbar: g
            } = this.Editor, f = yield h.convert(e, c.name, u.data);
        ...
        return r(a, null, [{
          ...
          value: function(c) {
            ...
            for (var u = 0; u < c.length; u++) {
              c[u] = c[u].toUpperCase();
              var h = false;
              for (var p in a.supportedCommands) if (a.supportedCommands[p].includes(c[u])) {
                h = this.commands[p] = true;
                break;
              }
              h || (this.keys[c[u]] = true);
            }
            for (var g in a.supportedCommands) this.commands[g] || (this.commands[g] = false);
          }
        }, {
          key: "execute",
          value: function(c) {
...
var eo = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Ki(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
...
var at = class to extends Te {
  ...
  enableShortcutForTool(e, t) {
    he.add({
      ...
      handler: (o) => __async(this, null, function* () {
        o.preventDefault();
        const i = this.api.blocks.getCurrentBlockIndex(), s = this.api.blocks.getBlockByIndex(i);
        if (s) try {
          const r = yield this.api.blocks.convert(s.id, e);
  ...
  insertNewBlock(e, t) {
    return __async(this, null, function* () {
      ...
      let r;
      if (t) {
        const a = yield this.api.blocks.composeBlockData(e);
        r = Object.assign(a, t);
      }
...
eo([ue], at.prototype, "toolsToBeDisplayed", 1);
eo([ue], at.prototype, "toolboxItemsToBeDisplayed", 1);
var Xi = at;
...
function Vi(n, e) {
  return __async(this, null, function* () {
    ...
    if (!t) return e;
    try {
      return (yield t.getLayoutMap()).get(n) || e;
    } catch (o) {
...
var qi = class extends y {
  ...
  make() {
    return __async(this, null, function* () {
      ...
      const t = d.make("div"), o = d.text(z.ui(K.ui.blockTunes.toggler, "Click to tune")), i = yield Vi("Slash", "/");
  ...
  makeToolbox() {
    ...
    }), this.toolboxInstance.on(Se.BlockAdded, ({
      block: e
    }) => {
      const {
        BlockManager: t,
        Caret: o
      } = this.Editor, i = t.getBlockById(e.id);
...
var dt = class {
   ...
   */
  prepare() {
    if (O(this.constructable.prepare)) return this.constructable.prepare({
      toolName: this.name,
...
var Zi = class extends y {
  ...
  tryToShow(e = false) {
    return __async(this, null, function* () {
      e && this.close(), this.allowedToShow() && (yield this.open(), this.Editor.Toolbar.close());
    });
  }
  /**
  ...
  open() {
    return __async(this, null, function* () {
      ...
      const e = yield this.getInlineTools();
      this.popover = new Ri({
        items: e,
        scopeElement: this.Editor.API.methods.ui.nodes.redactor,
        messages: {
  ...
  allowedToShow() {
    ...
    if (i === null || t && e.includes(i.tagName) || i.closest('[contenteditable="true"]') === null) return false;
  ...
  getInlineTools() {
    return __async(this, null, function* () {
      ...
      for (let s = 0; s < o.length; s++) {
        const r = o[s], l = r.create(), a = yield l.render();
        ...
        const u = c !== void 0 ? tt(c) : void 0, h = z.t(K.toolNames, r.title || Le(r.name));
        [a].flat().forEach((p) => {
          var f, k;
          const g = {
            name: r.name,
          ...
          if (d.isElement(p)) {
            const C = __spreadProps(__spreadValues({}, g), {
              element: p,
              type: A.Html
            });
            ...
            i.push(C);
          } else if (p.type === A.Html) i.push(__spreadProps(__spreadValues(__spreadValues({}, g), p), {
            type: A.Html
          }));
          else if (p.type === A.Separator) i.push({
            type: A.Separator
          });
          else {
            const C = __spreadProps(__spreadValues(__spreadValues({}, g), p), {
              type: A.Default
            });
  ...
  getToolShortcut(e) {
    const {
      Tools: t
    } = this.Editor, o = t.inlineTools.get(e), i = t.internal.inlineTools;
...
var Gi = class extends y {
  ...
  enter(e) {
    const {
      BlockManager: t,
      UI: o
    } = this.Editor, i = t.currentBlock;
    if (i === void 0 || i.tool.isLineBreaksEnabled || o.someToolbarOpened && o.someFlipperButtonFocused || e.shiftKey && !Ge) return;
    let s = i;
  ...
  backspace(e) {
    ...
    if (i === void 0 || !b.isCollapsed || !i.currentInput || !Me(i.currentInput)) return;
  ...
  delete(e) {
    ...
    if (!b.isCollapsed || !Ae(i.currentInput)) return;
  ...
  arrowRightAndDown(e) {
    ...
    const {
      currentBlock: o
    } = this.Editor.BlockManager, s = ((o == null ? void 0 : o.currentInput) !== void 0 ? Ae(o.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (le.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === w.TAB)) return;
      this.Editor.UI.closeAllToolbars();
    }
    this.Editor.Toolbar.close();
    const {
      currentBlock: t
    } = this.Editor.BlockManager, i = ((t == null ? void 0 : t.currentInput) !== void 0 ? Me(t.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
...
var es = class extends y {
  ...
  update(e, t, o) {
    return __async(this, null, function* () {
      if (!t && !o) return e;
      const i = yield e.data, s = this.composeBlock({
        id: e.id,
        tool: e.name,
  ...
  mergeBlocks(e, t) {
    return __async(this, null, function* () {
      ...
      if (e.name === t.name && e.mergeable) {
        ...
        const i = yield t.exportDataAsString(), s = q(i, e.tool.sanitizeConfig);
        o = xt(s, e.tool.conversionConfig);
      }
      o !== void 0 && (yield e.mergeWith(o), this.removeBlock(t), this.currentBlockIndex = this._blocks.indexOf(e));
    });
  }
  /**
   * Remove passed Block
  ...
  convert(e, t, o) {
    return __async(this, null, function* () {
      if (!(yield e.save())) throw new Error("Could not convert Block. Failed to extract original Block data.");
      const s = this.Editor.Tools.blockTools.get(t);
      if (!s) throw new Error(`Could not convert Block. Tool «${t}» not found.`);
      const r = yield e.exportDataAsString(), l = q(r, s.sanitizeConfig);
  ...
  clear(e = false) {
    return __async(this, null, function* () {
      ...
      }), yield t.completed, this.unsetCurrentBlock(), e && this.insert(), this.Editor.UI.checkEmptiness();
    });
  }
  /**
...
`), i = t.innerHTML;
  ...
  selectBlockByIndex(e) {
    const {
      BlockManager: t
    } = this.Editor, o = t.getBlockByIndex(e);
...
var Re = class _Re extends y {
  ...
  setToInput(e, t = this.positions.DEFAULT, o = 0) {
    const {
      currentBlock: i
    } = this.Editor.BlockManager, s = d.getDeepestNode(e);
    switch (t) {
      case this.positions.START:
        this.set(s, 0);
        break;
  ...
  navigatePrevious(e = false) {
    ...
    const {
      previousInput: i,
      currentInput: s
    } = t, r = s !== void 0 ? Me(s) : void 0, l = e || r || !t.focusable;
...
var os = class extends y {
  ...
  clear(e) {
    const {
      ...
      BlockSelection: o,
      Caret: i
    } = this.Editor, s = t.blocks.indexOf(this.firstSelectedBlock), r = t.blocks.indexOf(this.lastSelectedBlock);
  ...
  toggleBlocksSelectedState(e, t) {
    const {
      BlockManager: o,
      BlockSelection: i
    } = this.Editor, s = o.blocks.indexOf(e), r = o.blocks.indexOf(t), l = e.selected !== t.selected;
...
var is = class extends y {
  ...
  processDrop(e) {
    return __async(this, null, function* () {
      ...
      yield o.processDataTransfer(e.dataTransfer, true);
    });
  }
  /**
...
var ro = class lo extends y {
  constructor() {
    super(...arguments), this.MIME_TYPE = "application/x-editor-js", this.toolsTags = {}, this.tagsByTool = {}, this.toolsPatterns = [], this.toolsFiles = {}, this.exceptionList = [], this.processTool = (e) => {
      try {
        ...
        I(`Paste handling for «${e.name}» Tool hasn't been set up because of the error`, "warn", t);
      }
    }, this.handlePasteEvent = (e) => __async(this, null, function* () {
      const {
        BlockManager: t,
        Toolbar: o
      } = this.Editor, i = t.setCurrentBlockByChildNode(e.target);
   ...
   */
  processDataTransfer(e, t = false) {
    return __async(this, null, function* () {
      const {
        Tools: o
      } = this.Editor, i = e.types;
      if ((i.includes ? i.includes("Files") : i.contains("Files")) && !V(this.toolsFiles)) {
        yield this.processFiles(e.files);
        return;
      }
      ...
      !h.trim() || h.trim() === l || !d.isHTMLString(h) ? yield this.processText(l) : yield this.processText(h, true);
    });
  }
  /**
   ...
   */
  processText(e, t = false) {
    return __async(this, null, function* () {
      const {
        Caret: o,
        BlockManager: i
      } = this.Editor, s = t ? this.processHTML(e) : this.processPlain(e);
      if (!s.length) return;
      if (s.length === 1) {
      ...
      s.map((a, c) => __async(this, null, function* () {
        return this.insertBlock(a, c === 0 && l);
    ...
    t.forEach((i) => {
      ...
      o.push(...s), s.forEach((r) => {
        if (Object.prototype.hasOwnProperty.call(this.toolsTags, r)) {
          I(`Paste handler for «${e.name}» Tool on «${r}» tag is skipped because it is already used by «${this.toolsTags[r].tool.name}» Tool.`, "warn");
          return;
        }
  ...
  getPatternsConfig(e) {
    e.pasteConfig === false || !e.pasteConfig.patterns || V(e.pasteConfig.patterns) || Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
      o instanceof RegExp || I(`Pattern ${o} for «${e.name}» Tool is skipped because it should be a Regexp instance.`, "warn"), this.toolsPatterns.push({
        key: t,
        pattern: o,
        tool: e
      });
  ...
  processFiles(e) {
    return __async(this, null, function* () {
      ...
      let o;
      o = yield Promise.all(Array.from(e).map((r) => this.processFile(r))), o = o.filter((r) => !!r);
  ...
  processFile(e) {
    return __async(this, null, function* () {
      const t = Bo(e), o = Object.entries(this.toolsFiles).find(([r, {
        mimeTypes: l,
        extensions: a
      }]) => {
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      ...
      const {
        ...
        tags: []
      }, u = c.reduce((g, f) => (this.collectTagNames(f).forEach((C) => {
  ...
  processInlinePaste(e) {
    return __async(this, null, function* () {
      ...
      if (t.currentBlock && t.currentBlock.tool.isDefault && i.textContent.length < lo.PATTERN_PROCESSING_MAX_LENGTH) {
        const r = yield this.processPattern(i.textContent);
        if (r) {
      ...
      if (t.currentBlock && t.currentBlock.currentInput) {
        ...
        document.execCommand("insertHTML", false, q(i.innerHTML, r));
  ...
  insertEditorJSData(e) {
    ...
    it(e, (r) => i.blockTools.get(r).sanitizeConfig).forEach(({
      tool: r,
      data: l
    }, a) => {
      let c = false;
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags), s = e, {
      tool: r
    } = this.toolsTags[s.tagName] || {}, l = this.tagsByTool[r == null ? void 0 : r.name] || [], a = i.includes(s.tagName), c = d.blockElements.includes(s.tagName.toLowerCase()), u = Array.from(s.children).some(({
      tagName: p
    }) => i.includes(p) && !l.includes(p)), h = Array.from(s.children).some(({
      tagName: p
...
var as = class extends y {
   ...
   */
  toggle() {
    return __async(this, arguments, function* (e = !this.readOnlyEnabled, t = false) {
      ...
      const i = yield this.Editor.Saver.save();
      return yield this.Editor.BlockManager.clear(), yield this.Editor.Renderer.render(i.blocks), this.Editor.ModificationsObserver.enable(), this.readOnlyEnabled;
    });
  }
  /**
   ...
   */
  throwCriticalError() {
    throw new Pt(`To enable read-only mode all connected tools should support it. Tools ${this.toolsDontSupportReadOnly.join(", ")} don't support read-only mode.`);
  }
};
var xe = class _xe extends y {
  ...
  startSelection(e, t) {
    ...
    const s = [`.${D.CSS.content}`, `.${this.Editor.Toolbar.CSS.toolbar}`, `.${this.Editor.InlineToolbar.CSS.inlineToolbar}`], r = o.closest("." + this.Editor.UI.CSS.editorWrapper), l = s.some((a) => !!o.closest(a));
  ...
  genHTML() {
    const {
      UI: e
    } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d.make("div", _xe.CSS.overlay, {}), i = d.make("div", _xe.CSS.overlayContainer, {}), s = d.make("div", _xe.CSS.rect, {});
  ...
  changingRectangle(e) {
    ...
    const {
      ...
      leftPos: o,
      index: i
    } = this.genInfoForMouseSelection(), s = this.startX > t && this.mouseX > t, r = this.startX < o && this.mouseX < o;
  ...
  save() {
    return __async(this, null, function* () {
      const {
        BlockManager: e,
        Tools: t
      } = this.Editor, o = e.blocks, i = [];
      try {
        o.forEach((l) => {
          i.push(this.getSavedData(l));
        });
        const s = yield Promise.all(i), r = yield it(s, (l) => t.blockTools.get(l).sanitizeConfig);
...
var ft = class {
  ...
  checkState() {
    ...
    } else this.nodes.button.innerHTML = yt, this.nodes.button.classList.remove(this.CSS.buttonUnlink), this.nodes.button.classList.remove(this.CSS.buttonActive);
    return !!e;
  }
  /**
...
var ao = class {
  ...
  render() {
    return __async(this, null, function* () {
      ...
      if (t === void 0) return [];
      const o = this.toolsAPI.getBlockTools(), i = yield zt(t, o);
      ...
      const s = i.reduce((c, u) => {
        ...
        return (h = u.toolbox) == null || h.forEach((p) => {
          c.push({
            ...
            closeOnActivate: true,
            onActivate: () => __async(this, null, function* () {
              const g = yield this.blocksAPI.convert(t.id, u.name, p.data);
              this.caretAPI.setToBlock(g, "end");
            })
          });
        }), c;
      }, []), r = yield t.getActiveToolboxEntry(), l = r !== void 0 ? r.icon : Kt, a = !pe();
      return {
        icon: l,
        name: "convert-to",
        hint: {
...
var ho = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? ms(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
...
var gt = class extends dt {
  ...
  get toolbox() {
    ...
    if (!V(e) && t !== false) return t ? Array.isArray(e) ? Array.isArray(t) ? t.map((o, i) => {
      const s = e[i];
      return s ? __spreadValues(__spreadValues({}, s), o) : o;
    }) : [t] : Array.isArray(t) ? t : [__spreadValues(__spreadValues({}, e), t)] : Array.isArray(e) ? e : [e];
  }
  /**
...
ho([ue], gt.prototype, "sanitizeConfig", 1);
ho([ue], gt.prototype, "baseSanitizeConfig", 1);
var bs = class {
  /**
   * @class
   ...
   */
  get(e) {
    const _a = this.config[e], {
      class: t,
      isInternal: o = false
    } = _a, i = __objRest(_a, [
      "class",
      "isInternal"
    ]), s = this.getConstructor(t), r = t[et.IsTune];
    return new s({
      name: e,
      constructable: t,
      config: i,
...
var ws = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? vs(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
...
var go = class extends y {
  ...
  prepare() {
    return __async(this, null, function* () {
      if (this.validateTools(), this.config.tools = qe({}, this.internalTools, this.config.tools), !Object.prototype.hasOwnProperty.call(this.config, "tools") || Object.keys(this.config.tools).length === 0) throw Error("Can't start without tools");
  ...
  toolPrepareMethodSuccess(e) {
    ...
    if (t.isInline()) {
      ...
      if (i.length) {
        I(`Incorrect Inline Tool: ${t.name}. Some of required methods is not implemented %o`, "warn", i), this.toolsUnavailable.set(t.name, t);
        return;
      }
    }
  ...
  prepareConfig() {
    const e = {};
    for (const t in this.config.tools) R(this.config.tools[t]) ? e[t] = this.config.tools[t] : e[t] = {
      class: this.config.tools[t]
    };
    return e;
  }
};
ws([ue], go.prototype, "getAllInlineToolsSanitizeConfig", 1);
...
var ys = class extends y {
  ...
  defaultBehaviour(e) {
    const {
      currentBlock: t
    } = this.Editor.BlockManager, o = e.target.closest(`.${this.CSS.editorWrapper}`), i = e.altKey || e.ctrlKey || e.metaKey || e.shiftKey;
    if (t !== void 0 && o === null) {
  ...
  processBottomZoneClick(e) {
    const t = this.Editor.BlockManager.getBlockByIndex(-1), o = d.offset(t.holder).bottom, i = e.pageY, {
      BlockSelection: s
    } = this.Editor;
...
var Bs = class {
  ...
  set configuration(e) {
    var o, i;
    R(e) ? this.config = __spreadValues({}, e) : this.config = {
      holder: e
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : true, (V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = {
      blocks: [t]
  ...
  validate() {
    ...
    if (Q(t) && !d.get(t)) throw Error(`element with ID «${t}» is missing. Pass correct holder's ID.`);
    if (t && R(t) && !d.isElement(t)) throw Error("«holder» value must be an Element node");
  }
  /**
   * Initializes modules:
  ...
  start() {
    return __async(this, null, function* () {
      yield ["Tools", "UI", "BlockManager", "Paste", "BlockSelection", "RectangleSelection", "CrossBlockSelection", "ReadOnly"].reduce((t, o) => t.then(() => __async(this, null, function* () {
        try {
          yield this.moduleInstances[o].prepare();
        } catch (i) {
          if (i instanceof Pt) throw new Error(i.message);
